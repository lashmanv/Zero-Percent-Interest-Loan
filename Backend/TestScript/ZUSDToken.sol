...
contract ZUSDToken is CheckContract, IZUSDToken {
    
    uint256 private _totalSupply;
    string constant internal _NAME = "ZUSD Stablecoin";
    string constant internal _SYMBOL = "ZUSD";
    ...
    // --- Addresses ---
    address public immutable troveManager1Address;
    address public immutable troveManager2Address;
    address public immutable troveManager3Address;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(_balances[sender] >= amount, "ZUSD: Insufficient balance");
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        require(_balances[account] >= amount, "ZUSD: Insufficient balance");
    ...
    function _requireValidRecipient(address _recipient) internal view {
        ...
        require(
            ...
            _recipient != troveManager1Address && 
            _recipient != troveManager2Address && 
            _recipient != troveManager3Address && 
