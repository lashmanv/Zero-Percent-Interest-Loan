...
contract BorrowerOperationsTester is BorrowerOperations {
    ...
    returns (uint) 
    {
        return _getNewTCRFromTroveChange(_collId,_collChange, isCollIncrease, _debtChange, isDebtIncrease, _price);
    }
    ...
    (
        ...
        external 
    {
        _adjustTrove(_borrower,_collateralTokenId, _collWithdrawal, _debtChange, _isDebtIncrease, _upperHint, _lowerHint, 0);
    }
