...
const ercToken = require ( "../client/src/artifacts/TestScript/AAAERC.sol/MyToken.json");
  ...
  describe('Zero loan Unit Tests', async function () {
    ...
    it("CloseTrove with 5 ETH and 1800 ZUSD", async () => {
      const signerId = 1;
      ...
      let error = await closeTrove(signerId);

      expect(error).to.include("revert", "VM Exception while processing transaction: reverted with reason string 'TroveManager: Only one trove in the system'");
    ...
    it("CloseTrove with 1.25 ETH and 1800 ZUSD", async () => {
      const signerId = 2;
    ...
    it("CloseTrove with 1.15 ETH and 1800 ZUSD", async () => {
      const signerId = 3;
    ...
    it("CloseTrove with 5 WETH Token and 1800 ZUSD", async () => {
      const signerId = 4;
      const tokenId = 1;
    ...
    it("CloseTrove with 1.5 WETH Token and 1800 ZUSD", async () => {
      const signerId = 5;
      const tokenId = 1;
    ...
    it("CloseTrove with 1.25 WETH Token and 1800 ZUSD", async () => {
      const signerId = 6;
      const tokenId = 1;
    ...
    it("CloseTrove with 5 WBTC Token and 1800 ZUSD", async () => {
      const signerId = 7;
      const tokenId = 2;
      const token = ethers.utils.parseUnits('5')
      const zusd = ethers.utils.parseUnits('1800')
    ...
    it("CloseTrove with 1.25 WBTC Token and 1800 ZUSD", async () => {
      const signerId = 9;
      const tokenId = 2;
      const token = ethers.utils.parseUnits('1.25')
      const zusd = ethers.utils.parseUnits('1800')
    ...
    it("CloseTrove with 10 WBNB Token and 1800 ZUSD", async () => {
      const signerId = 10;
      const tokenId = 3;
    ...
    it("CloseTrove with 8.5 WBNB Token and 1800 ZUSD", async () => {
      const signerId = 11;
      const tokenId = 3;
    ...
    it("CloseTrove with 8.25 WBNB Token and 1800 ZUSD", async () => {
      const signerId = 12;
      const tokenId = 3;
    ...
    it("CloseTrove with 150 WSOL Token and 1800 ZUSD", async () => {
      const signerId = 13;
      const tokenId = 4;
    ...
    it("CloseTrove with 125 WSOL Token and 1800 ZUSD", async () => {
      const signerId = 14;
      const tokenId = 4;
    ...
    it("CloseTrove with 120 WSOL Token and 1800 ZUSD", async () => {
      const signerId = 15;
      const tokenId = 4;
    ...
    it("CloseTrove with 3000 USDC Token and 1800 ZUSD", async () => {
      const signerId = 16;
      const tokenId = 5;
    ...
    it("CloseTrove with 2750 USDC Token and 1800 ZUSD", async () => {
      const signerId = 17;
      const tokenId = 5;
    ...
    it("CloseTrove with 2500 USDC Token and 1800 ZUSD", async () => {
      const signerId = 18;
      const tokenId = 5;
