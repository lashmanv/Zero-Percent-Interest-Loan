...
const ercToken = require ( "../client/src/artifacts/TestScript/AAAERC.sol/MyToken.json");
  ...
  describe('Zero loan Unit Tests', async function () {
    ...
    describe('Default Pool Sequence Liquidation', async function () {
      before(async () => {
        try {
      ...
      it("OpenTrove with 5 ETH and 1800 ZUSD", async () => {
        ...
        let afterBalance = await defaultPoolContract.getTokenBalances();

        expect(afterBalance[0]).to.equal("0");
      ...
      it("OpenTrove with 1.25 ETH and 1800 ZUSD", async () => {
        ...
        let previousBalance = await defaultPoolContract.getTokenBalances();

        await openTrovewithEth(signerId, eth, zusd, upperHint, lowerHint);
        
        let afterBalance = await defaultPoolContract.getTokenBalances();
        expect(afterBalance[0]).to.equal(previousBalance[0]);
      ...
      it("OpenTrove with 5 WETH Token and 1800 ZUSD", async () => {
        ...
        let afterBalance = await defaultPoolContract.getTokenBalances();
        expect(afterBalance[tokenId]).to.equal(previousBalance[tokenId]);
      ...
      it("Default Pool Token balance after 2 ETH Troves liquidation", async () => {  
          const tokenId = 0;
          const zusd = ethers.utils.parseUnits('1800')
          const expected = ethers.utils.parseUnits('2.288500000000000000')
      ...
      it("Default Pool Token balance after 2 WETH Troves liquidation", async () => {  
        const tokenId = 1;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('2.388000000000000000')
      ...
      it("Default Pool Token balance after 2 WBTC Troves liquidation", async () => {  
        const tokenId = 2;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('2.388000000000000000')
      ...
      it("Default Pool Token balance after 2 WBNB Troves liquidation", async () => {  
        const tokenId = 3;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('16.666250000000000000')
      ...
      it("Default Pool Token balance after 2 WSOL Troves liquidation", async () => {  
        const tokenId = 4;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('243.775000000000000000')
      ...
      it("Default Pool Token balance after 2 USDC Troves liquidation", async () => {  
        const tokenId = 5;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('5223.750000000000000000')
    ...
    describe('Stablility Pool Random Liquidation', async function () {
      ...
      it("Default Pool Token ZUSD balance after 1 WETH Trove liquidation", async () => {  
        const tokenId = 1;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('1.144250000000000000')
      ...
      it("Default Pool Token ZUSD balance after 2 WBTC Troves liquidation", async () => {  
        const tokenId = 2;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('2.388000000000000000')
      ...
      it("Default Pool Token ZUSD balance after 1 WETH Troves liquidation", async () => {  
        const tokenId = 1;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('2.386855750000000000')
      ...
      //     console.log('');
      // })
      it("Default Pool Token ZUSD balance after 1 USDC Troves liquidation", async () => {  
        const tokenId = 5;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('2487.500000000000000000')
      ...
      it("Default Pool Token ZUSD balance after 2 WSOL Troves liquidation", async () => {  
        const tokenId = 4;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('243.775000000000000000')
      ...
      it("Default Pool Token ZUSD balance after 1 USDC Troves liquidation", async () => {  
        const tokenId = 5;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('5219.336693548387096788')
      ...
      it("Default Pool Token ZUSD balance after 2 WBNB Troves liquidation", async () => {  
        const tokenId = 3;
        const zusd = ethers.utils.parseUnits('1800')
        const expected = ethers.utils.parseUnits('16.666250000000000000')
