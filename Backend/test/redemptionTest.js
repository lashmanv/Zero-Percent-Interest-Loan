  ...
  describe('Zero loan Unit Tests', async function () {
    ...
    async function openTrovewithEth(signerId, ethAmount, zusdAmount, upperHint, lowerHint) {
        try {
            ...
            // console.log(await zusdTokenContract.connect(signers[signerId]).balanceOf(signers[19].getAddress()));
    ...
    describe('Sequence Redemption', async function () {
      before(async () => {
        try {
      ...
      // it("Sequence Redemption with same price ETH Troves", async () => {  
      //     const tokenId = 0;

      //     let previousBalance = await zusdTokenContract.balanceOf(signers[19].address);
      //     expect(previousBalance).to.equal(0);

      //     let error = await redeem(tokenId, 2);
      ...
      // it("Revert when Sequence Redemption all the ETH Troves", async () => {  
      //     const tokenId = 0;

      //     let previousBalance = await zusdTokenContract.balanceOf(signers[19].address);
      //     expect(previousBalance).to.equal(0);

      //     let error = await redeem(tokenId, 3);
      ...
      it("Redeem ETH for 1809 ZUSD", async () => {  
          const tokenId = 0;
          const zusd = ethers.utils.parseUnits('1809');
          const prevEx = ethers.utils.parseUnits('1800').mul(18);
          const afterEx = (ethers.utils.parseUnits('1800').mul(18)).sub(zusd);

          let previousBalance = await zusdTokenContract.balanceOf(signers[19].address);
          expect(previousBalance).to.equal(prevEx);
          ...
          let balance = await signers[19].getBalance();
      ...
      // it("Revert when Sequence Redemption all the WETH Troves", async () => {  
      //     const tokenId = 1;
      ...
      it("Redeem WETH for 1809 ZUSD", async () => {  
        const tokenId = 1;
        const zusd = ethers.utils.parseUnits('1809');
        const prevEx = (ethers.utils.parseUnits('1800').mul(18)).sub(zusd);
        ...
        let balance = await ercToken1Contract.connect(signers[19]).balanceOf(signers[19].getAddress());
    ...
    it("Redeem WBTC for 1809 ZUSD", async () => {  
        const tokenId = 2;
        const zusd = ethers.utils.parseUnits('1809');
        ...
        let balance = await ercToken2Contract.connect(signers[19]).balanceOf(signers[19].getAddress());
    ...
    it("Redeem WBNB for 1809 ZUSD", async () => {  
        const tokenId = 3;
        const zusd = ethers.utils.parseUnits('1809');
        const prevEx = await zusdTokenContract.balanceOf(signers[19].address);;
        const afterEx = prevEx.sub(zusd);
        ...
        let balance = await ercToken3Contract.connect(signers[19]).balanceOf(signers[19].getAddress());
    ...
    it("Redeem USDC for 1809 ZUSD", async () => {  
        const tokenId = 5;
        const zusd = ethers.utils.parseUnits('1809');
        const prevEx = await zusdTokenContract.balanceOf(signers[19].address);;
        const afterEx = prevEx.sub(zusd);
        ...
        let balance = await ercToken5Contract.connect(signers[19]).balanceOf(signers[19].getAddress());
...
//     // it("Revert when Sequence Redemption all the WBTC Troves", async () => {  
//     //     const tokenId = 2;
...
//     it("Sequence Redemption 2 WBTC Troves", async () => {  
//         const tokenId = 2;
//         const zusd = ethers.utils.parseUnits('1200')

//         await redeem(tokenId, 2);
...
//     // it("Revert when Sequence Redemption all the WBNB Troves", async () => {  
//     //     const tokenId = 3;
...
//     it("Sequence Redemption 2 WBNB Troves", async () => {  
//         const tokenId = 3;
...
//     // it("Revert when Sequence Redemption all the WSOL Troves", async () => {  
//     //     const tokenId = 4;
...
//     it("Sequence Redemption 2 WSOL Troves", async () => {  
//         const tokenId = 4;
...
//     // it("Revert when Sequence Redemption all the USDC Troves", async () => {  
//     //     const tokenId = 5;
...
//     it("Sequence Redemption 2 USDC Troves", async () => {  
//         const tokenId = 5;
...
//   describe('Random Redemption', async function () {
//     before(async () => {
//       try {
...
//     // it("Revert when Random Redemption all the ETH Troves", async () => {  
//     //     const tokenId = 0;
...
//     it("Random Redemption 2 ETH Troves", async () => {  
//         const tokenId = 0;
...
//     // it("Revert when Random Redemption all the WETH Troves", async () => {  
//     //     const tokenId = 1;
...
//     it("Random Redemption 1 WETH Troves", async () => {  
//         const tokenId = 1;
//         const zusd = ethers.utils.parseUnits('600')

//         await redeem(tokenId, 1);
...
//     // it("Revert when Random Redemption all the WBTC Troves", async () => {  
//     //     const tokenId = 2;
...
//     it("Random Redemption 2 WBTC Troves", async () => {  
//         const tokenId = 2;
...
//     // it("Revert when Random Redemption all the WBNB Troves", async () => {  
//     //     const tokenId = 3;
...
//     // it("Revert when Random Redemption all the WSOL Troves", async () => {  
//     //     const tokenId = 4;
...
//     //     console.log('');
//     // })
//     it("Random Redemption 1 USDC Troves", async () => {  
//       const tokenId = 5;
...
//     it("Random Redemption 2 WSOL Troves", async () => {  
//         const tokenId = 4;
//         const zusd = ethers.utils.parseUnits('1800')
...
//     it("Random Redemption 2 WBNB Troves", async () => {  
//       const tokenId = 3;
//       const zusd = ethers.utils.parseUnits('2400')
